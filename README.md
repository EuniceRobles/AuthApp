...
//Open XXAMP, start Apache and MySQL. Launch admin. Go to SQL tab and paste the following:
...
//create newfolder named flutterapi in xxamp/htdocs
dbconfig.php (file)
<?php
...
try {
    ...
    if ($row = $res->fetch_assoc()) {
        ...
        if ($ok) {
            echo json_encode(['status' => 'success', 'message' => 'Login successful', 'id' => (int)$row['id'], 'username' => $row['username']]);
        } else {
...
// Check if backend is working. put localhost/flutterapi.
